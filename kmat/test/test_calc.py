...
3. Define a series of test functions, each targeting a specific function from the 'kmat.utils.preprocessing' module.
...
By running these tests, the reliability and correctness of the signal processing functions in the 'kmat.utils.preprocessing' module will be ensured.
"""
...
import pytest
from kmat.utils.preprocessing import (
...
from kmat.utils.quaternion import (
    quatinv,
    quatnormalize,
    quatnorm,
    quatconj,
...
def test_lowpass_filter_savgol():
    """
    Test for lowpass_filter_savgol function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
...
def test_lowpass_filter_fir():
    """
    Test for lowpass_filter_fir function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
    test_signal = random_input_signal
    method = "fir"
...
def test_lowpass_filter_savgol_specific():
    """
    Test specific parameters for Savitzky-Golay filter in the 'kmat.utils.preprocessing' module.
    """
...
def test_lowpass_filter_butter_specific():
    """
    Test specific parameters for Butterworth filter in the 'kmat.utils.preprocessing' module.
    """
    # Test with specific parameters
    test_signal = np.ones(100)
    order = 3
...
def test_highpass_filter_iir():
    """Test for highpass_filter_iir function in the 'kmat.utils.preprocessing' module."""
    # Test with inputs
...
def test_iir_highpass_filter():
    """Test for _iir_highpass_filter function in the 'kmat.utils.preprocessing' module."""
    # Test with inputs
    test_signal = np.random.rand(100)
    sampling_frequency = 40
...
def test_apply_continuous_wavelet_transform():
    """
    Test for apply_continuous_wavelet_transform function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
    test_signal = random_input_signal
    scales = 10
...
def test_apply_successive_gaussian_filters():
    """
    Test for apply_successive_gaussian_filters function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
    test_signal = random_input_signal
...
def test_calculate_envelope_activity():
    """
    Test for calculate_envelope_activity function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
    test_signal = random_input_signal
    smooth_window = 20
...
def test_find_consecutive_groups():
    """
    Test for find_consecutive_groups function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
...
def test_find_local_min_max():
    """
    Test for find_local_min_max function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
    test_signal = random_input_signal
...
def test_identify_pulse_trains():
    """
    Test for convert_pulse_train_to_array function in the 'kmat.utils.preprocessing' module.
    """
    # Test with inputs
    test_signal = random_input_signal
...
def test_find_interval_intersection():
    """
    Test for organize_and_pack_results function in the 'kmat.utils.preprocessing' module.
    """
...
def test_wavelet_decomposition():
    """
    Test for wavelet_decomposition function in the 'kmat.utils.preprocessing' module.
    """
...
def test_moving_var():
    """
    Test for moving_var function in the 'kmat.utils.preprocessing' module.
    """
    # Generate a random input signal
    input_signal = np.random.randn(1000)

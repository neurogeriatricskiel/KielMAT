...
| [Initial Contact Detection](https://neurogeriatricskiel.github.io/KielMAT/modules/icd/) | Detects initial contacts within each gait cycle | 3D accelerations from lower back IMU (Paraschiv-Ionescu) or 3D heel & pelvis markers from optical motion capture (Leeuwen) | [Mobilise-D](https://neurogeriatricskiel.github.io/KielMAT/datasets/mobilised/) and [KeepControl](https://neurogeriatricskiel.github.io/KielMAT/datasets/keepcontrol/) | initial contact | Temporal parameters (e.g., step time, stride time) |
| [Final Contact Detection](https://neurogeriatricskiel.github.io/KielMAT/modules/fcd/) | Detects final contacts (toe-offs) within each gait cycle | 3D heel & pelvis markers from optical motion capture (Leeuwen) | - | final contact | Temporal parameters (e.g., stance & swing time) |

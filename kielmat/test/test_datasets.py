...
def test_load_recording_success(mock_fetch_dataset, mock_load_matlab, mock_dataloader):
    ...
    recording = load_recording(cohort=cohort, file_name=file_name, dataset_path=dataset_path)
...
def test_load_recording_missing_dataset(mock_fetch_dataset, mock_load_matlab, mock_dataloader):
    # Setup mock data
    mock_load_matlab.return_value = {
        "TimeMeasure1": {
            "Recording4": {
